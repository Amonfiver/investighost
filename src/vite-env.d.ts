...
declare global {
  interface Window {
    electronAPI: {
      ...
      requestDestinationBatchRedo: (input: { jobId: string; scope: import('./shared/factory-batch-contracts').DestinationBatchRedoScope; reason?: string }) => Promise<import('./shared/factory-batch-contracts').DestinationBatchJob>
